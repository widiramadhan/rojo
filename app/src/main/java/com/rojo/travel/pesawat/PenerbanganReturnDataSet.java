...
public class PenerbanganReturnDataSet {

    String token, flight_id, domestik, airlines_name, flight_number, stop, price_value, price_adult,
            price_child, price_infant, airlines_real_name, simple_departure_time, simple_arrival_time,
            departure_city_name,  arrival_city_name,
            full_via, image, departure_flight_date_str, departure_date, return_date;

    public PenerbanganReturnDataSet(){}

    public PenerbanganReturnDataSet(String token, String flight_id, String domestik, String airlines_name, String flight_number,
                                    String stop, String price_value, String price_adult, String price_child,
                                    String price_infant, String airlines_real_name, String simple_departure_time,
                                    ...
                                    String departure_date, String return_date) {
        this.token = token;
